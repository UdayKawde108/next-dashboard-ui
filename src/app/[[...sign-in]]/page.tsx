        ...
        <SignIn.Root>
            <SignIn.Step name='start' className='bg-white p-12 rounded-md shadow-2xl flex flex-col gap-2'>
                <h1 className='text-xl font-bold flex items-center gap-2'>
                    <Image src="/logo.png" alt="" width={52} height={50}/>
                    Smart Trash Manager</h1>
                <h2 className='text-gray-400'>Sign In To Your Account</h2>

                <Clerk.GlobalError className='text-sm text-red-400'/>
                <Clerk.Field name="identifier" className='flex flex-col gap-2'>
                    <Clerk.Label className='text-xs text-gray-500'>Username</Clerk.Label>
                    <Clerk.Input type="text" className='p-2 roundeed-md ring-1 ring-gray-300'required />
                    <Clerk.FieldError className='text-xs text-red-400'/>
                </Clerk.Field>
                 <Clerk.Field name="password"className='flex flex-col gap-2'>
                    <Clerk.Label className='text-xs text-gray-500'>Password</Clerk.Label>
                    <Clerk.Input  className='p-2 roundeed-md ring-1 ring-gray-300'type="password" required/>
                    <Clerk.FieldError className='text-xs text-red-400'/>
                </Clerk.Field>
